...
--
-- Table structure for table `deaths_delta_ma_14`
--

DROP TABLE IF EXISTS `deaths_delta_ma_14`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deaths_delta_ma_14` (
  `UID` bigint(20) NOT NULL,
  `location` bigint(20) NOT NULL,
  `day` date NOT NULL,
  `number` float NOT NULL,
  PRIMARY KEY (`UID`) USING BTREE,
  UNIQUE KEY `location_day` (`location`,`day`) USING BTREE,
  CONSTRAINT `deaths_delta_ma_14_ibfk_1` FOREIGN KEY (`location`) REFERENCES `locations` (`UID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `deaths_states_delta_ma_14`
--

DROP TABLE IF EXISTS `deaths_states_delta_ma_14`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deaths_states_delta_ma_14` (
  `UID` bigint(20) NOT NULL,
  `location` bigint(20) NOT NULL,
  `day` date NOT NULL,
  `number` float NOT NULL,
  PRIMARY KEY (`UID`) USING BTREE,
  UNIQUE KEY `location_day` (`location`,`day`) USING BTREE,
  CONSTRAINT `deaths_states_delta_ma_14_ibfk_1` FOREIGN KEY (`location`) REFERENCES `state_codes` (`UID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
/*!50003 DROP FUNCTION IF EXISTS `intUID` */;
...
DELIMITER ;;
CREATE DEFINER=`covid`@`%` FUNCTION `intUID`() RETURNS bigint(20)
BEGIN
        set @epoch=1293858000;
        return CONCAT(unix_timestamp()-@epoch,right(CONV(SUBSTRING(UUID(),1,8),16,10),9));
END ;;
DELIMITER ;
...
-- Dump completed on 2020-07-06 12:34:39
